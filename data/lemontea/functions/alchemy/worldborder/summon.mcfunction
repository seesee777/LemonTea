...
# 储存坐标
execute as @e[type=block_display,tag=worldcenter,limit=1,distance=..2,sort=nearest] at @s run function lemontea:alchemy/worldborder/save_pos

# 特效
function lemontea:alchemy/worldborder/set_effects