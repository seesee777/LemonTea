...
execute if score @s LT_position_Y matches ..-52 run tellraw @p[limit=1,sort=nearest,distance=..5] [{"text": "建造高度过低","color": "yellow"}]
execute if score @s LT_position_Y matches ..-52 run return 4

function lemontea:alchemy/construct/build/1stdaycamp/result