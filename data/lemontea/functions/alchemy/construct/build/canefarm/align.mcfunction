...
function lemontea:chunk_align/get_xz {"score_X":"#16 LT_constant","score_Y":"#4 LT_constant","score_Z":"#16 LT_constant"}
...
execute as @s at @s run fill ~ ~ ~ ~15 ~8 ~15 dirt

# 读取结构
execute as @s at @s run place template lemontea:chrisbigd/canefarm ~ ~ ~
