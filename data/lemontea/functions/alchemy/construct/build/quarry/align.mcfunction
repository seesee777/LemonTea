...
function lemontea:chunk_align/get_xz {"score_X":"#16 LT_constant","score_Y":"#5 LT_constant","score_Z":"#16 LT_constant"}
...
# 读取结构
execute as @s at @s run place template lemontea:chrisbigd/quarry ~ ~ ~
